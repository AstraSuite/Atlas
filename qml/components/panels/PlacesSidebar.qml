...
StyledRect {
    ...
    ColumnLayout {
        ...
        // Scrollable Places & Devices List
        Flickable {
            id: flickable
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        ...
                        delegate: StyledRect {
                            ...
                            readonly property bool selected: root.activeTab && driveItem.isMounted && root.activeTab.currentPath === mountPoint
                            ...
                            MouseArea {
                                ...
                                onClicked: mouse => {
                                    if (mouse.button === Qt.RightButton) {
                                        ...
                                        if (driveItem.isMounted && !driveItem.mountPoint.isEmpty()) {
                                            if (root.activeTab) {
    ...
    Item {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.03; color: "black" }
                GradientStop { position: 0.97; color: "black" }
